...
class InPageCommentsHooks {
  public static function renderCommentForm($text, $params=array(), $parser=null, $frame=false) {
    ...
    return Xml::openElement('form', array('action'=>SpecialPage::getTitleFor('InPageComments')->getLocalURL(), 'method'=>'post', 'id'=>'in_page_comments_form', 'class'=>'initial'))
         ...
         . Xml::input('c', false, false, array('type'=>'text', 'id'=>'in_page_comments_box', 'maxlength'=>$wgInPageCommentsMaxLetters, 'placeholder'=>InPageCommentsUtil::message($wgInPageCommentsFormMessage)))
